...
export function App() {
  ...
  // Allow NavBar (or any child) to open the modal via a custom event
  useEffect(() => {
    const handler = () => setModalOpen(true);
    window.addEventListener("kwan:openConsulta", handler);
    return () => window.removeEventListener("kwan:openConsulta", handler);
  }, []);
    ...
    <>
      ...
      {!loading && !showVideoBanner && (
        ...
        >
          ...
          {/* Floating WhatsApp button → opens modal */}
          <button
